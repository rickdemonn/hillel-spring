...
public class AppointmentDtoConverterImpl implements AppointmentDtoConverter {
    ...
    @Override
    public void updateModel(Appointment appointment, AppointmentInputDto dto, Integer docId, LocalDate localDate, Integer busyHour) {
        if ( dto == null && docId == null && localDate == null && busyHour == null ) {
            return;
        }
